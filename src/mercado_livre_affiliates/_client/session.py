...
from playwright.async_api import Cookie, BrowserContext, Page, async_playwright
...
class MercadoLivreAffiliatesSession(
    ...
    def __repr__(self) -> str:
        return f"MercadoLivreAffiliatesSession(gmail_address={self.gmail_address}, app_password=*, browser_context={self.__browser_context})"
    ...
    async def get_cookies(self) -> list[Cookie]:
        return await self.__browser_context.cookies()
