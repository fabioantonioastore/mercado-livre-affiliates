...
PRODUCTS_DEALS_BY_CATEGORIES: dict[str, set[str]] = {
    "https://www.mercadolivre.com.br/ofertas?category=MLB251478": {
        OfferCategory.antiques_and_collectibles.value(), OfferCategory.antiques_and_collectibles.antiques.value(), OfferCategory.antiques_and_collectibles.antiques.medal_holder.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB180312": {
        OfferCategory.antiques_and_collectibles.value(), OfferCategory.antiques_and_collectibles.antiques.value(), OfferCategory.antiques_and_collectibles.antiques.trophy.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB393901": {
        OfferCategory.antiques_and_collectibles.value(), OfferCategory.antiques_and_collectibles.flags.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB1806": {
        OfferCategory.antiques_and_collectibles.value(), OfferCategory.antiques_and_collectibles.banknotes_and_coins.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB2662": {
        OfferCategory.antiques_and_collectibles.value(), OfferCategory.antiques_and_collectibles.sculptures.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB433161": {
        OfferCategory.antiques_and_collectibles.value(), OfferCategory.antiques_and_collectibles.militaria_and_related_items.value(), OfferCategory.antiques_and_collectibles.militaria_and_related_items.knife_sheaths.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB2296": {
        OfferCategory.antiques_and_collectibles.value(), OfferCategory.antiques_and_collectibles.militaria_and_related_items.value(), OfferCategory.antiques_and_collectibles.militaria_and_related_items.tactical_gear.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB4377": {
        OfferCategory.games.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.console_accessories.for_nintendo.value(), OfferCategory.games.console_accessories.for_nintendo.nintendo_64.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB271448": {
        OfferCategory.games.console_accessories.for_nintendo.nintendo_switch.cases_and_sleeves.value(), OfferCategory.games.console_accessories.for_nintendo.nintendo_switch.value(),
        OfferCategory.games.console_accessories.for_nintendo.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB272187": {
        OfferCategory.games.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.console_accessories.for_nintendo.value(), OfferCategory.games.console_accessories.for_nintendo.nintendo_switch.value(),
    ...
    "https://www.mercadolivre.com.br/ofertas?category=MLB38536": {
        OfferCategory.games.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.console_accessories.for_playstation.value(), OfferCategory.games.console_accessories.for_playstation.playstation_3.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB277786": {
        OfferCategory.games.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.console_accessories.for_playstation.value(), OfferCategory.games.console_accessories.for_playstation.playstation_4.value(), OfferCategory.games.console_accessories.for_playstation.playstation_4.bases_and_supports.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB118902": {
        OfferCategory.games.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.console_accessories.for_playstation.value(), OfferCategory.games.console_accessories.for_playstation.playstation_4.value(), OfferCategory.games.console_accessories.for_playstation.playstation_4.gamepads_and_joysticks.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB439072": {
        OfferCategory.games.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.console_accessories.for_playstation.value(), OfferCategory.games.console_accessories.for_playstation.playstation_4.value(), OfferCategory.games.console_accessories.for_playstation.playstation_4.audio_and_video_for_gaming.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB455274": {
        OfferCategory.games.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.console_accessories.for_playstation.value(), OfferCategory.games.console_accessories.for_playstation.playstation_5.value(), OfferCategory.games.console_accessories.for_playstation.playstation_5.controller_charges.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB455268": {
        OfferCategory.games.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.console_accessories.for_playstation.value(), OfferCategory.games.console_accessories.for_playstation.playstation_5.value(), OfferCategory.games.console_accessories.for_playstation.playstation_5.controller_cases.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB455266": {
        OfferCategory.games.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.console_accessories.for_playstation.value(), OfferCategory.games.console_accessories.for_playstation.playstation_5.value(), OfferCategory.games.console_accessories.for_playstation.playstation_5.gamepads_and_joysticks.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB455412": {
        OfferCategory.games.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.console_accessories.for_playstation.value(), OfferCategory.games.console_accessories.for_playstation.playstation_5.value(), OfferCategory.games.console_accessories.for_playstation.playstation_5.audio_and_video_for_gaming.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB5189": {
        OfferCategory.games.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.console_accessories.playstation_2.value(), OfferCategory.games.console_accessories.playstation_2.memory_cards.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB414209": {
        OfferCategory.games.value(), OfferCategory.games.console_accessories.value(), OfferCategory.games.console_accessories.playstation_2.value(), OfferCategory.games.console_accessories.playstation_2.microphones.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB439598": {
        OfferCategory.games.value(), OfferCategory.games.pc_gaming_accessories.value(), OfferCategory.games.pc_gaming_accessories.gaming_chairs.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB448169": {
        OfferCategory.games.value(), OfferCategory.games.pc_gaming_accessories.value(), OfferCategory.games.pc_gaming_accessories.controllers_and_joysticks.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB439596": {
        OfferCategory.games.value(), OfferCategory.games.pc_gaming_accessories.value(), OfferCategory.games.pc_gaming_accessories.headphones.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB439599": {
        OfferCategory.games.value(), OfferCategory.games.pc_gaming_accessories.value(), OfferCategory.games.pc_gaming_accessories.microphones.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB439595": {
        OfferCategory.games.value(), OfferCategory.games.pc_gaming_accessories.value(), OfferCategory.games.pc_gaming_accessories.vr_headset.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB11172": {
        OfferCategory.games.value(), OfferCategory.games.consoles.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB438638": {
        OfferCategory.games.value(), OfferCategory.games.console_parts.value(), OfferCategory.games.console_parts.for_playstation.value()
    },
    "https://www.mercadolivre.com.br/ofertas?category=MLB438637": {
        OfferCategory.games.value(), OfferCategory.games.console_parts.value(), OfferCategory.games.console_parts.for_xbox.value()
    }
}


def add_promotion_type_to_url(url: str, promotion_type: Literal["deal_of_the_day", "lightning"]) -> str:
    if "?" in url:
        ...
        while has_next_page:
            ...
            for product_locator in products_locators:
                try:
                    ...
                    product["total_reviews"] = await extract_total_reviews(locator=locator)
        ...
        while has_next_page:
            ...
            for product_locator in products_locators:
                try:
                    ...
                    product["expires_in"] = await generate_countdown_timestamp(locator=locator)
                    locator = product_locator.locator(".poly-component__title")
                    product["title"] = await extract_title(locator=locator)
                    product["url"] = await extract_url(locator=locator)
                    locator = product_locator.locator("img")
